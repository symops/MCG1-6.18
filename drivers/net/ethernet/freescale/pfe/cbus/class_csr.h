...
#define CLASS_IPSEC_SA1_BASE_ADDR	(CLASS_IPSEC_SA0_BASE_ADDR + CLASS_ROUTE_SIZE)	/* Can be configured */
#define CLASS_IPSEC_SA2_BASE_ADDR	(CLASS_IPSEC_SA1_BASE_ADDR + CLASS_ROUTE_SIZE)	/* Can be configured */
#define CLASS_IPSEC_SA3_BASE_ADDR	(CLASS_IPSEC_SA3_BASE_ADDR + CLASS_ROUTE_SIZE)	/* Can be configured */
